...
const AllApplications = () => {
  ...
  const handleClosePermit = () => setShowPermit(false);
  ...
  const [titleDocument,setTitltDocument] = useState("")
  const [mechanicalPlan,setMechanicalPlan] = useState("")
  ...
  const fetchData1 = async (id) => {
    setIsLoading(true);
    try {
      const response = await axios.get(`${BASE_URL}/applicant/application/details`, {
        headers,
        params: { id },
      });
      console.log(response?.data?.data)
    ...
    // setBuildingArea(response?.data?.dat)
     setType(response?.data?.data[0]?.buildingPlan?.type?.description)
     console.log(response?.data?.data[0]?.building_plan?.type,"Getting the type")
     ...
     setMechanicalPlan(response?.data?.data[0]?.building_plan?.mechanical_plan)
     setStructuralPlan(response?.data?.data[0]?.building_plan?.structural_engineering)
     setTitltDocument(response?.data?.data[0]?.building_plan?.title_document)
     console.log(response?.data?.data[0]?.building_plan?.survey_plan)
                  ...
                  <Accordion.Item eventKey="2">
                    ...
                    <h5>Survey Plan</h5>
                      ...
                      <iframe
                              ...
                              title="Survey Plan"
                            ></iframe>
                    <h5>Building Architectural Plan</h5>
                      <iframe
                              src={buildingPlan}
                              width="100%"
                              height="500px"
                              ...
                              title="Survey Plan"
                            ></iframe>
                    <h5>Electrical Architectural Plan </h5>
                      <iframe
                              src={electricalPlan}
                              width="100%"
                              height="500px"
                              ...
                              title="Survey Plan"
                            ></iframe>
                    <h5>Mechanical Architectural Plan </h5>
                      <iframe
                              src={mechanicalPlan}
                              width="100%"
                              height="500px"
                              ...
                              title="Survey Plan"
                            ></iframe>
                    <h5>Structural Architectural Plan </h5>
                      <iframe
                              src={structuralPlan}
                              width="100%"
                              height="500px"
