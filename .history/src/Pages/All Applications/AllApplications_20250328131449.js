...
const AllApplications = () => {
  ...
  const fetchData1 = async (id) => {
    ...
    try {
      ...
      console.log(response?.data?.data[0]?.building_plan?.p_type?.description,"Getting the full info")
     setType(response?.data?.data[0]?.building_plan?.p_type?.description,"Getting the full info")
                    ...
                    <Accordion.Body>
                      ...
                      <table className="table m-0 bg-white display table-bordered table-striped table-hover card-table">
                        <tbody style={{ whiteSpace: "nowrap" }}>
                          ...
                          <tr>
                            <th>Type</th>
                            <td>{roless?.building_plan?.p_type?.description}</td>
                          </tr>
                        </tbody>
                      </table>
                    </Accordion.Body>
