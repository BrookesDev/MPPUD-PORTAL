...
import Olarms from '../../Asset/ogunlogonew.svg'
...
const Invoices = () => {
  ...
  const readData = async () => {
    ...
    const { responseData, responseData1, responseData2, responseData3 } = location.state || {};
    console.log(responseData1)
    const totalAmount = responseData1
    .map((fee) => parseFloat(fee.amount)) // Convert string amounts to numbers
              ...
              <div style={{ minWidth: '600px' }}>
                <header>
                  <div className={classes.headerCont}>
                        <img src={Olarms} className={classes.mppudLogo}  alt="Logo" />
                 
                   
                    <div className={classes.colcompanydetails}>
                      <h2 className={classes.colorgreenh2}>
                        
                        Ogun State Ministry of Physical Planning & Urban Development
                     
                      </h2>
                      <p> Ogun State Secretariat, Block C, Oke-Mosan Abeokuta, Ogun State.</p>
                ...
                <main className={classes.fullmargin}>
                  <div className={classes.rowcontacts}>
                    ...
                    <div className={classes.colinvoiceto}>
                      ...
                      <h2 className={classes.invTxt1}>{ responseData?.details.toUpperCase()}</h2>
                      <div className={classes.invTxt2}>{ responseData3?.address}</div>
                      <div >
                        <a href="/cdn-cgi/l/email-protection#016b6e696f416479606c716d642f626e6c"><span className="__cf_email__" data-cfemail="dbb1b4b3b59bbea3bab6abb7bef5b8b4b6">{ responseData3.email}</span></a>
                      </div>
                    </div>
                    <div className={classes.colinvoicedetails}>
                      <div className={classes.headercolor}>INVOICE</div>
                      <div>Date of Invoice: {formatDateTime( responseData.created_at)}</div>
                  ...
                  <div className={classes.rowcontactss}>
                    <div className={classes.colinvoicetos}>
                      ...
                      <div className={classes.invTxt3}>{ responseData.payment_code}</div>
                    </div>
                    <div className={classes.colinvoicedetails}>
                    <img src={QRIcon} alt="QR code" className={classes.logoimage1} />
                    </div>
                  </div>
                  ...
                  <div className={classes.belowData}>
                      ...
                      <div className={classes.belowDatas}>
                        ...
                        <p className={classes.textleft222}>{new Intl.NumberFormat('en-NG', { style: 'currency', currency: 'NGN' }).format(totalAmount)}</p>
                        </div>
                        <div style={{ width: '70%', borderTop: '2px solid #ccc', marginTop: -20, marginBottom: 10 }} />
                        <div className={classes.belowDatas}>
                        <td className={classes.textleft22212}>GRAND TOTAL</td>
                        <td className={classes.textleft22212}>{new Intl.NumberFormat('en-NG', { style: 'currency', currency: 'NGN' }).format(totalAmount)}</td>
                        </div>
                    </div>
