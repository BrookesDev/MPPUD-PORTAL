          ...
          ></span>
            ...
            <div className={classes.rgtcontainer}>
                <div className={classes.maintext}>
                    ...
                    <h6> Your password have been reset successfully, you can now log into your account with your email and new password. </h6>
                    <Button variant="success" onClick={handleLogin} className={classes.btngreen}>
                    Login to my account
                    </Button>
                </div>
            </div>
