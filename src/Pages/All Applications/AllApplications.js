            ...
            <div className={classes.allcards}>
              <div className={isDarkMode ? classes.twokadss : classes.twokad}>
                <div className={classes.twokadfrstp}>
                  ...
                  <p className={isDarkMode ? classes.walltp21 : classes.walltp2}>Total Applications</p>
                  <p className={`${isDarkMode ? classes.walltpmblk1 :classes.walltpmblk} ${classes.walltpmblka}`}>
                    {" "}
                    {benLoading ? (
              ...
              <div className={isDarkMode ? classes.twokadss : classes.twokad}>
                <div className={classes.twokadfrstp}>
                  ...
                  <p className={isDarkMode ? classes.walltp21 : classes.walltp2}>Not Paid</p>
                  <p className={`${isDarkMode ? classes.walltpmblk1 :classes.walltpmblk} ${classes.walltpmblka}`}>
                    {" "}
                    {benLoading ? (
                      <Placeholder animation="glow">
              ...
              <div className={isDarkMode ? classes.twokadss : classes.twokad}>
                <div className={classes.twokadfrstp}>
                  ...
                  <p className={isDarkMode ? classes.walltp21 : classes.walltp2}>Applications in Review</p>
                  <p className={`${isDarkMode ? classes.walltpmblk1 :classes.walltpmblk} ${classes.walltpmblka}`}>
                    {" "}
                    {benLoading ? (
                      <Placeholder animation="glow">
               ...
               <div className={isDarkMode ? classes.twokadss : classes.twokad}>
                <div className={classes.twokadfrstp}>
                  ...
                  <p className={isDarkMode ? classes.walltp21 : classes.walltp2}>Applications Completed</p>
                  <p className={`${isDarkMode ? classes.walltpmblk1 :classes.walltpmblk} ${classes.walltpmblka}`}>
                    {" "}
                    {benLoading ? (
                      <Placeholder animation="glow">
