            ...
            <div>
              ...
              >
                ...
                <h4 className={isDarkMode ? classes.wlcm1 : classes.wlcm}>
                  APPLICATION FORM FOR MASTER PLAN PERMIT
                </h4>
                </div>
                <div className={classes.prgText1}>
    ...
    click to copy <FiCopy size={16} />
            ...
            >
               <div
                                ...
                                style={{paddingLeft:0 }}
                              >
                                <h1>MASTER PLAN PERMIT APPLICATION FORM</h1>
                              </div>
              {/* <Row className="mb-3">
                                    <Col md={12}>
...
{/* )} */}
            ...
            <Modal
              ...
              >
                <Modal.Header>
                  ...
                  >
                   Preview Master Plan Permit Application Form
                  </Modal.Title>
                  <Button
                    variant="close"
          ...
          <div className={isDarkMode ? classes.applicationHistoryy : classes.applicationHistory}>
           <div></div>
                         ...
                         <div className={classes.profileContainer}>
                         <h4 className={isDarkMode ? classes.wlcm1 : classes.wlcmModal}>APPLICATION FORM FOR MASTER PLAN PERMIT</h4>
                           <img
                             src={customerPicture || customerPicture || ProfileIcon}
                             className={classes.imgPass}
                             alt="profileImage"
...
{/*               
     ...
     <div className={isDarkMode ? classes.firstInfos : classes.firstInfo} style={{marginTop:30,paddingLeft:10}}>
                                 <h1 style={{textTransform:'uppercase',}}>Master Plan Permit Application Form</h1>
                               </div>
...
{selectedType !== "1" && (
     ...
     <Button variant="secondary" onClick={handleClosePreview} className={classes.invBtn}>
        ...
        <FaInfoCircle size={50} className="text-warning mb-3" />
          ...
          <h5 className="fw-bold">Submit Master Plan Permit Application</h5>
...
export default MasterPlanApplications;
