...
const PlanInformationApplications = () => {
  ...
  const [modeAcquisition, setModeAcquisition] = useState([]);
  const [landUseStatus, setLandUseStatus] = useState([]);
  ...
  const [fileName32, setFileName32] = useState("Land Purchase Agreement");
  const [fileName34, setFileName34] = useState("Land Information");
  const [fileName35, setFileName35] = useState("Site Location Plan");
  ...
  const [selectedModeAcquisition, setSelectedModeAcquisition] = useState("");
...
const [selectedZoneName, setSelectedZoneName] = useState("");
  ...
  const fetchLandStatus = async () => {
    setRoleLoading(true);
    try {
      const response = await axios.get(
        `${BASE_URL}/get_land_statuses`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${bearer}`,
  ...
  const fetchPlanInfo = async () => {
    ...
    try {
      const response = await axios.get(
        `${BASE_URL}/get_purchase_of_plan_info`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${bearer}`,
  ...
  const fetchModeAcquisition = async () => {
    setRoleLoading(true);
    try {
      const response = await axios.get(
        `${BASE_URL}/get_mode_of_acquisitions`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${bearer}`,
  ...
  const handleModeAcquisition = e => {
    setSelectedModeAcquisition(e.target.value);
    // setShowErrorMessage(false);
  };
  ...
  const createApplication1 = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${BASE_URL}/applications/save_planning_info`,
        formData,
        { headers }
      );
            ...
            <div>
              ...
              >
                ...
                <h4 className={isDarkMode ? classes.wlcm1 : classes.wlcm}>
                  APPLICATION FORM FOR PLAN INFORMATION
                </h4>
                </div>
                <div className={classes.prgText1}>
    ...
    click to copy <FiCopy size={16} />
            ...
            >
               <div
                                ...
                                style={{paddingLeft:0 }}
                              >
                                <h1>PLAN INFORMATION APPLICATION FORM</h1>
                              </div>
              {/* <Row className="mb-3">
                                    <Col md={12}>
              ...
              <Col md={6}>
                  <Form.Group controlId="proposedTimeline">
                    ...
                    >
                      Land Use Type<span style={{color:"red"}}>*</span>
                    </Form.Label>
                    <Form.Select
               ...
               {tableData32?.map((item, index) => (
                ...
                <Col md={6}>
                  <Form.Group controlId="option3">
                    ...
                    >
                      Land Status<span style={{color:"red"}}>*</span>
                    </Form.Label>
                    <Form.Select
                      className={classes.optioncss}
              ...
              <Col md={6}>
                  <Form.Group controlId="proposedTimeline">
                    ...
                    >
                      Mode of Acquisition of Land <span style={{color:"red"}}>*</span>
                    </Form.Label>
                    <Form.Select
                      className={classes.optioncss}
                      onChange={handleModeAcquisition}
                      value={selectedModeAcquisition}
                    >
                      <option value="">Select Mode of Acquisition</option>
               {modeAcquisition?.map((item, index) => (
                 <option
                   key={index}
                   value={item.id}
                   name={item.description}
                ...
                <Col md={6}>
                  <Form.Group controlId="option3">
                    ...
                    >
                      Purpose of Planning Information <span style={{color:"red"}}>*</span>
                    </Form.Label>
                    <Form.Select
                      className={classes.optioncss}
              ...
              <Row className="mb-3" style={{marginTop: 20}}>
                <Col md={6}>
                  ...
                  >
                    Land Purchase Agreement <span style={{fontSize: 10, fontWeight: 700}}>(only PDF is allowed)</span><span style={{color:"red"}}>*</span>
                  </Form.Label>
              ...
              <Row className="mb-3">
                  ...
                  >
                    Site Location Plan <span style={{fontSize: 10, fontWeight: 700}}>(only PDF is allowed)</span><span style={{color:"red"}}>*</span>
                  </Form.Label>
            ...
            <Modal
              ...
              >
                <Modal.Header>
                  ...
                  >
                   Preview Plan Information Application Form
                  </Modal.Title>
                  <Button
                    variant="close"
          ...
          <div className={isDarkMode ? classes.applicationHistoryy : classes.applicationHistory}>
           <div></div>
                         ...
                         <div className={classes.profileContainer}>
                         <h4 className={isDarkMode ? classes.wlcm1 : classes.wlcmModal}>APPLICATION FORM FOR PLAN INFORMATION</h4>
                           <img
                             src={customerPicture || customerPicture || ProfileIcon}
                             className={classes.imgPass}
                             alt="profileImage"
...
{/*               
     ...
     <div className={isDarkMode ? classes.firstInfos : classes.firstInfo} style={{marginTop:30,paddingLeft:10}}>
                                 <h1 style={{textTransform:'uppercase',}}>Plan Information Application Form</h1>
                               </div>
                <Form className={ isDarkMode ? classes.formContainer1 : classes.formContainer}>
               <div
                                className={
                                  isDarkMode
                                    ? classes.firstInfos
     ...
     <Button variant="secondary" onClick={handleClosePreview} className={classes.invBtn}>
        ...
        <FaInfoCircle size={50} className="text-warning mb-3" />
          ...
          <h5 className="fw-bold">Submit Plan Information Application</h5>
...
export default PlanInformationApplications;
