...
const OpticsFirbreApplications = () => {
            ...
            <div>
              ...
              >
                ...
                <h4 className={isDarkMode ? classes.wlcm1 : classes.wlcm}>
                  APPLICATION FORM FOR OPTICS FIBRE, PIPELINES, LAYOUT ROUTE
                </h4>
                </div>
                <div className={classes.prgText1}>
    ...
    click to copy <FiCopy size={16} />
            ...
            >
               <div
                                ...
                                style={{paddingLeft:0 }}
                              >
                                <h1>OPTICS FIBRE, PIPELINES, LAYOUT ROUTE APPLICATION FORM</h1>
                              </div>
              {/* <Row className="mb-3">
                                    <Col md={12}>
...
{/* )} */}
            ...
            <Modal
              ...
              >
                <Modal.Header>
                  ...
                  >
                   Preview Optics Fibre, Pipelines, Layout Route Application Form
                  </Modal.Title>
                  <Button
                    variant="close"
          ...
          <div className={isDarkMode ? classes.applicationHistoryy : classes.applicationHistory}>
           <div></div>
                         ...
                         <div className={classes.profileContainer}>
                         <h4 className={isDarkMode ? classes.wlcm1 : classes.wlcmModal}>APPLICATION FORM FOR OPTICS FIBRE, PIPELINES, LAYOUT ROUTE</h4>
                           <img
                             src={customerPicture || customerPicture || ProfileIcon}
                             className={classes.imgPass}
                             alt="profileImage"
...
{/*               
     ...
     <div className={isDarkMode ? classes.firstInfos : classes.firstInfo} style={{marginTop:30,paddingLeft:10}}>
                                 <h1 style={{textTransform:'uppercase',}}>Optics Fibre, Pipelines, Layout Route Application Form</h1>
                               </div>
...
{selectedType !== "1" && (
     ...
     <Button variant="secondary" onClick={handleClosePreview} className={classes.invBtn}>
        ...
        <FaInfoCircle size={50} className="text-warning mb-3" />
          ...
          <h5 className="fw-bold">Submit Optics Fibre, Pipelines, Layout Route Application</h5>
...
export default OpticsFirbreApplications;
